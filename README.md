...
* The Consensus weather data combines data from G2F with data from NASA for variables not recorded by G2F as well as missing records. For further information about each of these networsk please see the corresponding "mdfiles".
