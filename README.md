...
|External weather data|[ASOSdaily.csv]() - [NOAAdaily.csv]()|[repository]()|[link](https://github.com/QuantGen/G2F_RESOURCES/blob/main/ExternalWeatherData.md)|Gets daily weather data from external sources|
